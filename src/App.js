...
import Profile from './pages/Profile'; // додай зверху
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/web-lab3/register" element={<Register />} /> {/* Маршрут для реєстрації */}
        <Route path="/web-lab3/login" element={<Login />} /> {/* Маршрут для реєстрації */}
